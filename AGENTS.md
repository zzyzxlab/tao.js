...
under the [`TAO-SPEC.md`](./TAO-SPEC.md) §3 unordered contract — pre-1.0, wrappers
move to declared responses ([`MESH-SPEC.md`](./MESH-SPEC.md) §4):

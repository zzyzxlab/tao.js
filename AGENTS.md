...
- **2026-07-18** — Mutation testing on `@tao.js/core` via Stryker: `pnpm test:mutation:core` (`packages/tao/stryker.config.json`, `inPlace: true`). Score raised to **~90.3%** (was ~88%). Reports gitignored under `packages/tao/reports/mutation/`.

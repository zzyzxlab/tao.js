...
- documents that app's TAO — its declared Space (Terms, Actions, Orients) and its Protocols ([`MESH-SPEC.md` §3](./MESH-SPEC.md#3-the-space-and-the-apps-tao))
...
- [ ] implement TAO.md (spec/template + tooling for consuming apps — the app's TAO: Space + Protocols, [`MESH-SPEC.md` §3](./MESH-SPEC.md#3-the-space-and-the-apps-tao); declared mode ships like a package)

...
```javascript
import { Kernel } from '@tao.js/utils';
```
...
```javascript
import TAO, { AppCtx } from '@tao.js/utils';
```
...
```javascript
const TAO = require('@tao.js/utils').default;

// OR
const Kernel = require('@tao.js/utils').Kernel;

// OR
const tao = require('@tao.js/utils');
tao.Kernel;
```
